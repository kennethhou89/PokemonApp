...
export function SetLogoCard({ set, onClick }: { set: TCGSet; onClick: () => void }) {
  return (
    <button
      onClick={onClick}
      className="flex-shrink-0 w-36 overflow-hidden rounded-lg bg-gray-50 active:bg-gray-100 transition-colors snap-start text-left"
    >
...
export function SetLogoCardSkeleton() {
  return (
    <div className="flex-shrink-0 w-36 rounded-lg bg-gray-50 overflow-hidden snap-start">
